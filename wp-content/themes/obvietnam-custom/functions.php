...
function custom_breadcrumbs() {
    ...
    echo '<ol class="inline-flex items-center space-x-1 md:space-x-2">';

    // Trang chủ - Luôn hiển thị
    echo '<li class="inline-flex items-center">';
    echo '<a href="' . home_url() . '" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-blue-600">';
